...
case class AiConfig(
  ...
  def >> = (variant.id, timeMode.id, time, increment, days, level, color.name, openingBook, fen.map(_.value)).some
...
object AiConfig extends BaseConfig {
  ...
  def <<(v: Int, tm: Int, t: Double, i: Int, d: Int, level: Int, c: String, o: String, fen: Option[String]) = new AiConfig(
